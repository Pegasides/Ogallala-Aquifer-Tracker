...
(function(){
  ...
  window.OATFacilityRegistry={
    ...
    mappedLocations:[
 {name:'Duos Edge AI — Amarillo',place:'Potter County, Texas',status:'operational',relation:'On or near the aquifer',profile:'profile-duos-amarillo',x:39.1,y:45.2},{name:'Duos Edge AI — Hereford',place:'Deaf Smith County, Texas',status:'operational',relation:'Over the aquifer',x:37.7,y:47.0},{name:'Duos Edge AI — Lubbock',place:'Lubbock County, Texas',status:'operational',relation:'Over the aquifer',x:40.8,y:54.5},{name:'Duos Edge AI — Dumas',place:'Moore County, Texas',status:'operational',relation:'Over the aquifer',x:40.6,y:40.3},{name:'Microsoft — Cheyenne campuses',place:'Cheyenne, Wyoming',status:'operational',relation:'Northern border region',profile:'profile-cheyenne',x:27.9,y:19.8},{name:'Meta — Sarpy Campus',place:'Sarpy County, Nebraska',status:'operational',relation:'Eastern regional site',profile:'profile-meta-sarpy',x:52.0,y:25.6},
 {name:'Project Matador — Fermi America',place:'Carson / Potter County area, Texas',status:'construction',relation:'Over the aquifer',profile:'profile-matador',x:41.0,y:44.2},{name:'Google–Crusoe Goodnight / Project Llano',place:'Armstrong County, Texas',status:'construction',relation:'Over the aquifer',profile:'profile-armstrong',x:42.2,y:44.9},{name:'Google — Haskell campuses (2)',place:'Haskell County, Texas',status:'construction',relation:'Southern border region',x:43.5,y:60.1},{name:'Google–Intersect Meitner',place:'Gray / Roberts Counties, Texas',status:'construction',relation:'Over the aquifer',x:43.0,y:41.8},{name:'Project Caprock — Aligned',place:'Abernathy, Hale County, Texas',status:'construction',relation:'Over the aquifer',x:40.3,y:51.8},{name:'Meta — Cheyenne',place:'Cheyenne, Wyoming',status:'construction',relation:'Northern border region',x:29.1,y:20.7},{name:'Meta — Tulsa',place:'Tulsa / Catoosa, Oklahoma',status:'construction',relation:'Eastern regional border',profile:'profile-meta-tulsa',x:50.9,y:56.0},{name:'Vantage Frontier',place:'Shackelford County, Texas',status:'construction',relation:'Southern border region',profile:'profile-vantage-frontier',x:45.2,y:61.4},
 {name:'Project Jade / Cheyenne AI Factory',place:'Laramie County, Wyoming',status:'proposed',relation:'Paused / on hold in northern border region',profile:'profile-jade',x:27.2,y:21.1},{name:'Microsoft — Cheyenne expansion',place:'Cheyenne, Wyoming',status:'proposed',relation:'Northern border region',profile:'profile-cheyenne',x:28.6,y:18.7},{name:'Beltline',place:'Yukon, Canadian County, Oklahoma',status:'proposed',relation:'Eastern aquifer-border region',profile:'profile-beltline',x:49.8,y:57.3},{name:'Google — Wilbarger County campus',place:'Wilbarger County, Texas',status:'proposed',relation:'Southeast regional border',x:47.0,y:57.8},{name:'Black Pearl — Cipher / AWS conversion',place:'Winkler County, Texas',status:'proposed',relation:'Operational site; AI conversion underway near southwest border',x:32.4,y:60.0}
],
    powerProfiles:[
